...
| `variant`  | `variant`  | The different variants. The options are: `"default"`, `"primary"`, `"secondary"`, `"danger"`, `"success"`, and `"plain"`.                                                              | `"danger" \| "default" \| "plain" \| "primary" \| "secondary" \| "success"` | `'default'` |
