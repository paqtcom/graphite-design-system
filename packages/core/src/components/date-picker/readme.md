...
| `localization`      | --                   | Specify date picker's localization. Can be used if localization is not supported internally. If not specified, defaulted to use the browser's localization and if not supported, defaulted to english.                         | `localization`                                                                                                                                            | `browserLocalization` |
