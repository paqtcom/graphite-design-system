...
export class FileUpload {
  ...
  @State() hasStage: 'dropzone' | 'files' | 'progress' = 'dropzone';
  ...
  connectedCallback() {
    ...
    this.handleSlotChange = this.handleSlotChange.bind(this);(this);
      ...
      >
        <div class='dropzone-center'>
          ...
          {this.errors.length ? (
            ...
            <div class='dropzone-hint'>{this.helpText}</div>
          )}
        </div>
      </div>
    );
